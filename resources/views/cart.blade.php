    ...
    <div class="lg:w-96 md:w-8/12 w-full bg-gray-100 dark:bg-gray-900 h-full">
      <div class="flex flex-col lg:h-screen h-auto lg:px-8 md:px-7 px-4 lg:py-20 md:py-10 py-6 justify-between overflow-y-auto">
        ...
        <div>
          ...
          <button onclick="emptyCart()" class="text-base leading-none w-full mt-5 py-5 bg-white border-gray-800 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-grey-700 dark:hover:bg-gray-300">Vider le panier</button>
        </div>
      </div>
    </div>
...
$(document).ready(
  ...
  function emptyCart() {
      ...
      // fonction changer la quantitée de produit dans le panier
      // id : cart 
